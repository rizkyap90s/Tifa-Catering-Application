...
public class ModelPendingOrder implements Parcelable {
    public ModelPendingOrder() {
    }
    ...
    protected ModelPendingOrder(Parcel in) {
    ...
    public static final Creator<ModelPendingOrder> CREATOR = new Creator<ModelPendingOrder>() {
        @Override
        public ModelPendingOrder createFromParcel(Parcel source) {
            return new ModelPendingOrder(source);
        }

        @Override
        public ModelPendingOrder[] newArray(int size) {
            return new ModelPendingOrder[size];
        }
    };
}
