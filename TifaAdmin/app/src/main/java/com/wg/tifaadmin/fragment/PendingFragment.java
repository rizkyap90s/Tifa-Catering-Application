...
import com.wg.tifaadmin.model.ModelPendingOrder;
...
public class PendingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        progPending = view.findViewById(R.id.prog_pending);
        bgPending = view.findViewById(R.id.bg_pending);

        rvPending.setLayoutManager(new LinearLayoutManager(getActivity()));

        bgPending.setVisibility(View.VISIBLE);
        progPending.setVisibility(View.VISIBLE);
        Query query = db.collection("pending_order");
        FirestoreRecyclerOptions<ModelPendingOrder> respone = new FirestoreRecyclerOptions.Builder<ModelPendingOrder>()
                .setQuery(query, ModelPendingOrder.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<ModelPendingOrder, FriendsHolder>(respone) {
            @Override
            protected void onBindViewHolder(@NonNull FriendsHolder holder, int position, @NonNull final ModelPendingOrder model) {
            ...
            public FriendsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v = LayoutInflater.from(getActivity()).inflate(R.layout.custom_item_request, parent, false);
        ...
        bgPending.setVisibility(View.GONE);
        progPending.setVisibility(View.GONE);
