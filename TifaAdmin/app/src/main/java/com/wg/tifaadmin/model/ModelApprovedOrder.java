...
public class ModelApprovedOrder implements Parcelable {
    ...
    protected ModelApprovedOrder(Parcel in) {
    ...
    public static final Creator<ModelApprovedOrder> CREATOR = new Creator<ModelApprovedOrder>() {
        @Override
        public ModelApprovedOrder createFromParcel(Parcel source) {
            return new ModelApprovedOrder(source);
        }

        @Override
        public ModelApprovedOrder[] newArray(int size) {
            return new ModelApprovedOrder[size];
        }
    };
}
