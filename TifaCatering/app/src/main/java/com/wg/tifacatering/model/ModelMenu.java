...
public class ModelMenu implements Parcelable {
    ...
    protected ModelMenu(Parcel in) {
        ...
        minimal_pesan = Integer.parseInt(in.readString());
    ...
    public ModelMenu(int id_paket, String nama_paket, String grup_paket, String isi_paket, int harga_paket, String image_paket,int minimal_pesan) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(String.valueOf(minimal_pesan));
