...
public class AdapterNasiBox extends RecyclerView.Adapter<AdapterNasiBox.MyHolder> {
    Context context;
    List<ModelNasiBox> list;
    FirebaseAuth firebaseAuth;
    FirebaseStorage storage;
    public Fragment fragment;

    public AdapterNasiBox(Context context, List<ModelNasiBox> list) {
    ...
    @NonNull
    @Override
    public AdapterNasiBox.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alerDetail.setView(view);
                alerDetail.setCancelable(true);
                alerDetail.setPositiveButton("Buy", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (firebaseAuth.getCurrentUser() == null) {
                            AlertDialog.Builder masukDulu = new AlertDialog.Builder(context);
                            masukDulu.setMessage("Anda belum Login, Login sekarang ?").setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    context.startActivity(new Intent(context, SignInSignUpActivity.class));
                                }
                            }).setCancelable(true);
                            Dialog masuk = masukDulu.create();
                            masuk.show();
                        } else {
